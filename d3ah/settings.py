...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'ibtest',                  # Not used with sqlite3.
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_DIR, 'branding/static'),
)
...
SECRET_KEY = 'ta!h8#9zi_dc83e783*led8c_6#noxuns*t+08o%wa050tjok6'
...
ROOT_URLCONF = 'd3ah.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'd3ah.wsgi.application'
